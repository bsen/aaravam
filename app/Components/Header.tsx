...
const Header: React.FC = () => {
  ...
  return (
    <header className="h-[8vh] w-full fixed top-0 bg-transparent backdrop-blur-md z-50">
...
const MenuButton: React.FC<MenuButtonProps> = ({ label }) => (
  <div className="text-white/90 font-medium text-lg hover:bg-indigo-500 px-4 py-2 md:py-0 rounded-full transition-transform cursor-pointer duration-500 ease-in-out hover:scale-110">
    {label}
  </div>
);
